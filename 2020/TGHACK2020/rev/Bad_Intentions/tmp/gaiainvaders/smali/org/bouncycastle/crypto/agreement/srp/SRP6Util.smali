...
.method public static calculateX(Lorg/bouncycastle/crypto/Digest;Ljava/math/BigInteger;[B[B[B)Ljava/math/BigInteger;
    ...
    invoke-interface {p0, p3, v1, v0}, Lorg/bouncycastle/crypto/Digest;->update([BII)V
    ...
    invoke-interface {p0, p4, v1, p3}, Lorg/bouncycastle/crypto/Digest;->update([BII)V

    invoke-interface {p0, p1, v1}, Lorg/bouncycastle/crypto/Digest;->doFinal([BI)I

    array-length p3, p2

    invoke-interface {p0, p2, v1, p3}, Lorg/bouncycastle/crypto/Digest;->update([BII)V

    array-length p2, p1

    invoke-interface {p0, p1, v1, p2}, Lorg/bouncycastle/crypto/Digest;->update([BII)V
